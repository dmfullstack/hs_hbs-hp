let config = {
  JWT_SECRET: 'BasavSagarVikramSurya0123456789AbCdEfGhIjKlMnOpQrStUvWxYz',
  ...
  MONGO: {
    DBNAME : process.env.HOBBES_DB || 'hobbesLearn',
    HOST: process.env.MONGO_HOST || "localhost",
    PORT: process.env.MONGO_PORT || 27017,
  },
  AUTH_PROVIDER: process.env.AUTH_PROVIDER || "gitlab-learn",
  USER_AUTH: {
   "gitlab-learn":{
      PROVIDER: "gitlab-learn",
      CLIENT_ID: '0fb7b9b6850f7a2cc4b9d57377cffac2b6d16e82fe3dcfa76acee86f7b360b42',
      CLIENT_SECRET: '4ca0a150b992fd04c08799a5a0682be662e87c0f8ed2327ef10f0d12cc737cb6',
      REDIRECT_URL: 'https://hobbes-learn.stackroute.in/api/v1/auth/cadet/gitlab-learn/complete',
